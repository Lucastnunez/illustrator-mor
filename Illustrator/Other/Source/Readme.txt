...
user in an INI file next to IllustratorPortable.exe called 
IllustratorPortable.ini. If you are happy with the default options, it is not 
necessary, though.  There is an example INI included with this package to get 
you started.  To use it, copy IllustratorPortable.ini from this directory next 
to IllustratorPortable.exe. 
